...
import com.example.anand.sunshine.WeatherContract.LocationEntry;
import com.example.anand.sunshine.WeatherContract.WeatherEntry;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        ...
        long startDate=1419120000L;
        type=mContext.getContentResolver().getType(WeatherEntry.buildWeatherLocationWithStartDate(testLocation,startDate));

        assertEquals("Error: the WeatherEntry CONTENT_URI with location and date should return WeatherEntry.CONTENT_ITEM_TYPE",WeatherEntry.CONTENT_TYPE,type);
